...
public final class Messages extends OkaeriConfig {
    ...
    public static class SetupMessages extends OkaeriConfig{
        ...
        public List<String> gameEndMessage = Arrays.asList(
                "&a▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
                ,""
                ,"                &a%thedragon_last_attacker% &7He hit the dragon the last blow."
                ,""
                ,"                &e&l1st Damager &7- %dragon_player_top_1_name% &7- &e%dragon_player_top_1_damage%"
                ,"                &6&l2nd Damager &7- %dragon_player_top_2_name% &7- &e%dragon_player_top_1_damage%"
                ,"                &c&l3rd Damager &7- %dragon_player_top_3_name% &7- &e%dragon_player_top_1_damage%"
                ,"                "
                ,"                &eYour Damage: &a%thedragon_player_damage% %the_dragon_player_got_new_record%&7(Position #%rank%)"
                ,"                &eRuneCrafting Experience: &d%thedragon_player_reward_xp%"
                ,"                "
                ,"&a▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬");
    }
