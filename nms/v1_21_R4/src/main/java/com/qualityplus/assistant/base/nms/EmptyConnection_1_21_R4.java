...
public final class EmptyConnection_1_21_R4 extends Connection {
    @NotNull
     ...
     */
    public EmptyConnection_1_21_R4(final PacketFlow flag) throws IOException {
        super(flag);
        channel = new EmptyChannel_1_21_R4(null);
