...
public final class EmptyConnection_1_21_R2 extends Connection {
    @NotNull
     ...
     */
    public EmptyConnection_1_21_R2(final PacketFlow flag) throws IOException {
        super(flag);
        channel = new EmptyChannel_1_21_R2(null);
