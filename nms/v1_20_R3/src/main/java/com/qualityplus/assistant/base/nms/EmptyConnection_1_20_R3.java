...
public final class EmptyConnection_1_20_R3 extends Connection {
    @NotNull
     ...
     */
    public EmptyConnection_1_20_R3(final PacketFlow flag) throws IOException {
        super(flag);
        channel = new EmptyChannel_1_20_R3(null);
