...
public final class EmptyConnection_1_21_R1 extends Connection {
    @NotNull
     ...
     */
    public EmptyConnection_1_21_R1(final PacketFlow flag) throws IOException {
        super(flag);
        channel = new EmptyChannel_1_21_R1(null);
